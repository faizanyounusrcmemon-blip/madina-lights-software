  ...
  return (
    <div className="topbar" ref={navRef}>
      <div className="nav-left">
        ...
        {/* SALES */}
        <div className="menu">
          <button className="menu-btn" onClick={() => toggleMenu("sales")}>
            🛒 Sales
          </button>
        ...
        {/* PURCHASE */}
        <div className="menu">
          <button className="menu-btn" onClick={() => toggleMenu("purchase")}>
            📦 Purchase
          </button>
        ...
        {/* MASTER */}
        <div className="menu">
          <button className="menu-btn" onClick={() => toggleMenu("master")}>
            📇 Master
          </button>
        ...
        {/* OPENING STOCK */}
        <div className="menu">
          <button className="menu-btn" onClick={() => toggleMenu("openingStock")}>
            🧊 Opening Stock
          </button>
        ...
        {/* REPORTS */}
        <div className="menu">
          <button className="menu-btn" onClick={() => toggleMenu("reports")}>
            📊 Reports
          </button>
